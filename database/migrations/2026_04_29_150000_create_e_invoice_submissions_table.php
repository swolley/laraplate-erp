...
return new class extends Migration
{
    ...
    {
        $e_invoice_submissions_table = ERPTables::EInvoiceSubmissions->value;
        Schema::create($e_invoice_submissions_table, function (Blueprint $table) use ($e_invoice_submissions_table): void {
            $table->id();
            ERPMigrateUtils::companyForeign($table);
            $table->foreignId('invoice_id')
                ->constrained(ERPTables::Invoices->value, 'id', "{$e_invoice_submissions_table}_invoice_id_FK")
                ->restrictOnDelete();
            ...
            $table->index(['invoice_id', 'provider_code'], "{$e_invoice_submissions_table}_invoice_provider_idx");
        });
    }

    public function down(): void
    {
        Schema::dropIfExists(ERPTables::EInvoiceSubmissions->value);
    }
};
