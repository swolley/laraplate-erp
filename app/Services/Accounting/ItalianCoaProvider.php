...
final class ItalianCoaProvider implements ChartOfAccountsProvider
{
    ...
    public function definitions(): array
    {
        ...
        return [
            ...
            $d('1103', 'Banche c/c attive', AccountKind::Asset, '110', ['civilistico' => 'Banche c/c', 'erp_role' => 'bank_cash']),
            ...
            $d('1201', 'Clienti', AccountKind::Asset, '120', ['civilistico' => 'Clienti', 'erp_role' => 'trade_receivable']),
            ...
            $d('1302', 'IVA acquisti detraibile (credito)', AccountKind::Asset, '130', ['erp_role' => 'vat_input']),
            ...
            $d('2101', 'Fornitori', AccountKind::Liability, '210', ['civilistico' => 'Fornitori', 'erp_role' => 'trade_payable']),
            $d('2102', 'Fornitori (fatture da ricevere)', AccountKind::Liability, '210'),
            $d('220', 'Debiti tributari', AccountKind::Liability, '21'),
            $d('2201', 'Erario c/IVA vendite', AccountKind::Liability, '220', ['erp_role' => 'vat_output']),
            ...
            $d('4101', 'Vendite merci e servizi', AccountKind::Revenue, '410', ['erp_role' => 'sales_revenue']),
            ...
            $d('5102', 'Acquisto di merci', AccountKind::Expense, '510', ['erp_role' => 'purchase_expense']),
            ...
            $d('5702', 'Commissioni e spese finanziarie', AccountKind::Expense, '570', ['erp_role' => 'bank_reconciliation_difference']),
